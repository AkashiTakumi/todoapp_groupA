...
public class ToDoController {
    ...
    String showToDoList(@PathVariable String mid, @RequestParam(name = "sort_by", required = false) String sortBy,
    ...
    String showAllToDoList(@PathVariable String mid, @RequestParam(name = "sort_by", required = false) String sortBy,
